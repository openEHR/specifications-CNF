...
image::diagrams/conformance_framework-artefacts.svg[id=conformance_framework-artefacts, align="center"]
...
[.text-center]
.Test items
image::diagrams/conformance_framework-chain.svg[id=conformance_framework-chain, align="center"]
