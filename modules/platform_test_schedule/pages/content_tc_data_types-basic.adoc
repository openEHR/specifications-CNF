...
include::partial$content_tc_data_types-text.adoc[leveloffset=+1]

include::partial$content_tc_data_types-quantity.adoc[leveloffset=+1]

include::partial$content_tc_data_types-date_time.adoc[leveloffset=+1]

include::partial$content_tc_data_types-time_specification.adoc[leveloffset=+1]

include::partial$content_tc_data_types-encapsulated.adoc[leveloffset=+1]

include::partial$content_tc_data_types-uri.adoc[leveloffset=+1]
