...
.8+|*ADMIN*     |*List transactions*|List CONTRIBUTIONs +
             ...
             .2+|*transaction +
                ...
                |*Bulk EHR Export*  |Export all EHRs        |ADMIN API              |API:commit x N; + 
                                                                                     API:export; +
                                                                                     file test / diff
...
.7+|*APIs*      |*DEFINITIONS REST API* |???                    |DEFINITIONS API        |xxx
                |*EHR REST API*         |???                    |EHR API                |Exercise all functions +
                                                                                         & arguments
                |*DEMOGRAPHIC REST API* |???                    |EHR API                |Exercise all functions +
                                                                                         & arguments
                |*QUERY REST API*       |???                    |QUERY API              |Exercise all functions +
                                                                                         & arguments
                |*CDS REST API*         |???                    |CDS API                |Exercise functions +
                                                                                         & arguments
                |*ADMIN REST API*       |???                    |ADMIN API              |Exercise functions +
                                                                                         & arguments
