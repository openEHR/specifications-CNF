== EHR Persistence Component Validation Suite
...
|Definition
  ...
  a|[%collapsible]
====
include::tc01-ehr.adoc[tag=EHR.has_ehr-main]
====

   |EHR.has_ehr-has_existing_subject_id
   |Alternative flow 1: +
    Check has EHR with existing EHR by subject_id
  a|[%collapsible]
====
include::tc01-ehr.adoc[tag=EHR.has_ehr-has_existing_subject_id]
====

   |EHR.has_ehr-non_existing_ehr_id
   |Alternative flow 2: +
    Check has EHR with non existing EHR id
  a|[%collapsible]
====
include::tc01-ehr.adoc[tag=EHR.has_ehr-non_existing_ehr_id]
====

   |EHR.has_ehr-non_existing_subject_id
   |Alternative flow 3: +
    Check has EHR with non existing EHR by subject_id
  a|[%collapsible]
====
include::tc01-ehr.adoc[tag=EHR.has_ehr-non_existing_subject_id]
====
|===
...
|Definition
  ...
  a|[%collapsible]
====
include::tc01-ehr.adoc[tag=EHR.create_ehr-main]
====

   |EHR.create_ehr-same_ehr_twice
   |Alternative flow 1: +
    Attempt to create same EHR twice
  a|[%collapsible]
====
include::tc01-ehr.adoc[tag=EHR.create_ehr-same_ehr_twice]
====

   |EHR.create_ehr-two-ehrs-same-patient
   |Alternative flow 2: +
    Create two EHRs for the same patient
  a|[%collapsible]
====
include::tc01-ehr.adoc[tag=EHR.create_ehr-two_ehrs_same_patient]
====
|===
