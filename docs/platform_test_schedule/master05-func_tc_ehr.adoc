...
==== TC I_EHR_STATUS.get_ehr_status-get_by_invalid_ehr_id
...
==== TC I_EHR_STATUS.set_ehr_queryable-non_existing_ehr
...
==== TC I_EHR_STATUS.set_ehr_modifiable-non_existing_ehr
...
==== TC I_EHR_STATUS.clear_ehr_queryable-non_existing_ehr
...
==== TC I_EHR_STATUS.clear_ehr_modifiable-non_existing_ehr
